...
<div class='col-md-6 col-lg-3 m-auto mb-3 border-dark'>
    <div class='card m-auto border border-white border-radius' style='width: 18rem;'>
        ...
        <img src="product/<?= $data['videoImage'] ?>" alt=""controls="false" style="height: 200px; border:0.1rem solid black; border-radius:10px;" class='card-img-top' controls>
            ...
            <a href="user-login.php" class="text-white text-decoration-none pe-2"> <svg id="video<?= $data['vid'] ?>" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="svgIcon" height="2rem" viewBox="0 0 384 512">
                    <path d="M73 39c-14.8-9.1-33.4-9.4-48.5-.9S0 62.6 0 80V432c0 17.4 9.4 33.4 24.5 41.9s33.7 8.1 48.5-.9L361 297c14.3-8.7 23-24.2 23-41s-8.7-32.2-23-41L73 39z" stroke="white" stroke-width="3rem" /></svg></a>
