            ...
            ?>
                        ...
                        <div class='col-md-6 col-lg-3 m-auto mb-3 border-dark'>
                            <div class='card m-auto border border-dark border-radius' style='width: 18rem;'>
                                ...
                                <img src="product/<?= $image ?>" alt=""controls="false" style="height: 200px; border:0.1rem solid black; border-radius:10px;" class='card-img-top' controls>
                            ...
                            <script>
                                ...
                                videoId<?= $vid ?>.addEventListener('click', (e) => {
                                    ...
                                    <div class="videoPop " >
                                                    ...
                                                    <div>
                                                    <p><a href="algorithm.php?vid=<?=$vid?>">click here for full screen</a></p>
                                                    </div>
                                                </div>`;
